...
check("Coastal page explains non-applicable locations instead of showing distant data", /not a coastal location for this tool/.test(pages.coastal) && /Source proximity is not location eligibility/.test(pages.coastal) && /data-coastal-detail/.test(pages.coastal), 5);
