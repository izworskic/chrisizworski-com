...
check("River activity lenses reuse facts without a combined score", ["General","Paddle","Fish","Swim","Ecology","Trip"].every((label) => pages.rivers.includes('>'+label+'<')) && /No combined safety score/.test(pages.rivers), 6);
