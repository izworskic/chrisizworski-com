...
function profileBox(){
  return `<aside class="trip-context" data-trip-context aria-live="polite"><div class="trip-context-copy"><span>Your trip intelligence</span><strong data-trip-context-title>Make the whole Mackinac site fit this trip</strong><p data-trip-context-summary>Four quick answers shape what matters on every Mackinac page you open next.</p></div><div class="trip-context-work" data-trip-context-work></div><div class="trip-context-actions" data-trip-context-actions></div></aside>`;
}
