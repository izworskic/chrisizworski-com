...
for(const url of ['https://chrisizworski.com/michigan-boat-launches/','https://chrisizworski.com/great-lakes-shipwrecks/']){
...
console.log('decision page sitemap dates aligned');
