...
const slugs=["day-trip","with-kids","2-day-itinerary","ferry-planner","from-detroit","from-chicago","from-traverse-city","from-grand-rapids","limited-walking","bike-day","fall"];
let fail=false;
