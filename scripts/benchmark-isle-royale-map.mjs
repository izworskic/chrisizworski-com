...
add('deep-data-path', 8, ['geology','vegetation-detailed','historic-brochure','quiet-no-wake'].every(x => cat.includes(x)) && /PMTiles|MBTiles/.test(read('docs/isle-royale-map-plan.md')), 'explicit ETL/tile path for deep layers');
