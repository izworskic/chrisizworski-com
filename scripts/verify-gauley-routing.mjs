...
assert.ok(pageHandler.includes("read('persona.css')"),'First-party page must include persona styling');
assert.ok(pageHandler.includes('persona-tabs'),'Page wrapper must verify the persona selector');
assert.ok(pageHandler.includes('decision-card'),'Page wrapper must verify the persona decision surface');
...
console.log('Gauley persona-first page-function routing: PASS');
