...
const value={decision_speed:/Best time to arrive/.test(html)?1:0,decision_confidence:/confidence/.test(route)?1:0,personalization:/persona/.test(route)&&/personaChips/.test(html)?1:0,live_relevance:/api\/mackinac-island/.test(js)?1:0,source_trust:/Live sources and freshness/.test(html)?1:0,actionability:/For an easy start, take the/.test(js)&&/Head back/.test(html)?1:0,return_visit_value:/fall color|events|crowd/i.test(all)?1:0};
