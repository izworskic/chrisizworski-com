...
add('First-screen riding decision',20,['id="status"','id="best"','id="risk"','id="confidence"','id="drive"','id="corridorSections"'].every(x=>page.includes(x))&&engine.includes('rankRideWindows'));
