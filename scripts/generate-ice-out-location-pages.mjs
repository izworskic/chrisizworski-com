...
const lakes=[
  ...
  {slug:'houghton-lake-michigan',id:'houghton-mi',name:'Houghton Lake, Michigan',search:'Houghton Lake',title:'Houghton Lake Ice-Out Forecast & Spring Timing | Chris Izworski',description:'Check Houghton Lake ice-out timing with calibrated history, live thaw weather, probability windows and NASA satellite imagery.'},
  ...
  {slug:'lake-simcoe-ontario',id:'simcoe-on',name:'Lake Simcoe, Ontario',search:'Lake Simcoe',title:'Lake Simcoe Ice-Out Forecast & Spring Timing | Chris Izworski',description:'Check Lake Simcoe ice-out timing with lake-specific spring signals, probability windows and NASA satellite imagery.'},
  {slug:'lake-of-the-woods',id:'lake-of-the-woods',name:'Lake of the Woods, Ontario & Minnesota',search:'Lake of the Woods',title:'Lake of the Woods Ice-Out Forecast & Timing | Chris Izworski',description:'Check Lake of the Woods ice-out timing with lake-specific spring signals, probability windows and NASA satellite imagery.'}
];
