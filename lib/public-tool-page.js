...
module.exports = function publicToolPage(source, transformHtml) {
  return async function handler(req, res) {
    ...
    try {
      ...
      html = sitePolicyLinks(allowAds ? html : adsenseEligibility.removeAdLoader(html));
      ...
      if (allowAds && !/<script\b[^>]*src=["'][^"']*pagead\/js\/adsbygoogle\.js\b/i.test(html)) tags.push(`<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-8222782620788075" crossorigin="anonymous"></script>`);
