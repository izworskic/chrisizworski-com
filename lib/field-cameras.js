...
const CAMERAS = Object.freeze({
  ...
  "windy-bay-city-yacht-club": {
    ...
    note: "This view can show broad water and sky conditions near Bay City. It cannot show the posted beach flag, water quality, ice thickness, or ice safety.",
  },
  "windy-caseville": {
    ...
    note: "This view can show broad surface and sky conditions near Caseville. It cannot show the posted beach flag, water quality, ice thickness, or ice safety.",
  },
  "windy-houghton-lake": {
    ...
    note: "A camera can show open water or broad surface cover. It cannot show ice thickness, ice quality, cracks, current, or whether the ice is safe.",
  },
  "windy-holland-state-park": {
    source: "windy", webcamId: 1606575521,
    label: "Lake Michigan at Holland State Park",
    credit: "Webcams provided by Windy.com", creditUrl: WINDY_CREDIT_URL,
    note: "Use this view for broad shoreline, visibility, and wave context. Follow the posted flag and official alerts at the beach.",
  },
  "windy-south-haven": {
  ...
  "windy-big-sable": {
    ...
    credit: "Webcams provided by Windy.com", creditUrl: WINDY_CREDIT_URL,
    note: "This camera is at Big Sable Point inside Ludington State Park. Use it for broad shoreline context, not as a substitute for posted flags or alerts.",
  },
  "windy-calumet-trail": {
    ...
    note: "This trail camera shows the local forest corridor. One view cannot represent color or snow conditions across the full Keweenaw Peninsula.",
  },
});
...
async function resolveWindy(entry, id, maxAgeHours) {
  ...
  if (!key) {
    return { ...entry, id, url: null, capturedAt: null, stale: true, reason: "camera access is not configured" };
  }
