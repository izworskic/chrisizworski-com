const { NOTE_DISCLOSURE } = require("../report-provenance.js");
...
module.exports = async (req, res) => {
  ...
  const body =
    ...
    "  <link>" + base + "/</link>\n" +
    "  <description>AI-generated daily summaries of Michigan fall-color model estimates and weather inputs, published by Chris Izworski.</description>\n" +
