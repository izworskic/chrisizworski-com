...
module.exports = (req, res) => {
  ...
  const urls = [{ loc: base + "/", pri: "1.0", freq: inSeason ? "daily" : "weekly" },
    { loc: base + "/when-do-leaves-peak-in-michigan", pri: "0.9", freq: inSeason ? "weekly" : "monthly" }]
    .concat(regions.map((s) => ({ loc: base + "/" + s, pri: "0.8", freq: inSeason ? "weekly" : "monthly" })));
  const body =
