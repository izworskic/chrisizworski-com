...
function evidenceVocabulary(activeSlot){
...
async function reviewEditorialNote(candidate,activeSlot,note){
...
module.exports = async function detroitOutdoors(req,res){
  ...
  res.status(200).json({
    ...
    notes:[
      ...
      "Park/weather, Great Lakes water, night-sky/aurora, fall-color/phenology, sunset-photography, and Great Lakes AIS engines can emit normalized opportunity candidates. Deterministic safety and validity gates run before the mixed pool reaches JEV.",
