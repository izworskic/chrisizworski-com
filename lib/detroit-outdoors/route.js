...
module.exports = async function detroitOutdoors(req,res){
  ...
  for(let i=0;i<PLACES.length;i++){
    ...
    safePool.push(...result.candidates);
  }
  ...
  res.status(200).json({
    ...
    notes:[
      ...
      "JEV receives every surviving place/activity candidate and acts as the board editor: it chooses the lead, the board posture, which additional cards earn space, and their order. The deterministic score is evidence only.",
