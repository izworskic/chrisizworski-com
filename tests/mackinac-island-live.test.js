...
test('Mackinac page cache-busts planner assets and removes stale leave-home copy', () => {
  const html=fs.readFileSync(htmlPath,'utf8');
  const js=fs.readFileSync(jsPath,'utf8');
  assert.match(html,/mackinac-island\.js\?v=20260920-causal4/);
  assert.match(html,/mackinac-island\.css\?v=20260920-causal4/);
