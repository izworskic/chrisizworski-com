(()=>{
  ...
  function stage2(){
    baseCard(
      '<div class="human-stage">'+
        '<div class="human-stage-head"><div><span class="human-planner-kicker">3 · People + movement</span><h2>Who is this plan responsible for?</h2><p>Mackinac is car-free, and the interior is hillier than many first-time visitors expect. Your group and walking comfort change whether the trip favors downtown, horse-drawn transport, shoreline riding, or steeper interior stops.</p></div><div class="human-stage-note">We’ll reduce needless hills and backtracking before we cut experiences you care about.</div></div>'+
