...
function loadTripStack(){if(document.querySelector('script[data-contextual-trip-stack-loader]'))return;const s=document.createElement('script');s.src='/assets/contextual-trip-stack.js?v=20260820-1';s.defer=true;s.dataset.contextualTripStackLoader='manistee';document.body.appendChild(s);}
function init(){styles();crispPanels();crispGuide();render();observeUi();loadTripStack();}
