...
function compactIntro(){const panel=$('#panel-places');if(!panel)return;const h2=$('h2',panel);const lede=$('.lede',panel);if(h2)h2.textContent='Access & places';if(lede)lede.textContent='Put-ins, takeouts, camps, trails and services.';}
function crispGuide(){
  $$('.guide h3').forEach(h=>{
